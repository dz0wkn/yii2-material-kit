<div>
  ...
  <nav class="navbar navbar-transparent bg-success  navbar-color-on-scroll fixed-top navbar-expand-lg" color-on-scroll="100" id="sectionsNav">
    <div class="container bg-success">
      <div class="navbar-translate">
        <a class="navbar-brand" href="#" rel="tooltip" data-placement="right" data-original-title="Follow us on Twitter">
          <span class="fa fa-print"></span> Material Kit </a>
      ...
      <div class="row">
        <div class="col-md-8 ml-auto mr-auto">
          <div class="brand" style="text-align: center;">
            <h1 style="font-weight: 900;font-size: 4em">Material Kit.</h1>
        ...
        <div class="row text-center">
          <div class="col-md-8 ml-auto mr-auto">
            ...
            <h4>Cause if you do, it can be yours for FREE. Hit the buttons below to navigate to our website where you can find the kit. Our friends from
              <a href="#" target="_blank">ThemeIsle</a> created a Wordpress Theme which can be also downloaded for free. Start a new project or give an old Bootstrap project a new look!</h4>
          </div>
        ...
        <div class="row text-center">
          <div class="col-md-8 ml-auto mr-auto">
            ...
            <h4>We've just launched
              <a href="#" target="_blank">Material Kit PRO</a>. It has a huge number of components, sections and example pages. Start Your Development With A Badass Bootstrap UI Kit inspired by Material Design.</h4>
          </div>
